      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <Link href="/products#switchgear">Switchgear</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/products#controlpanels">Control Panels</Link>
              </li>
            </ul>
          </div>
          <div className="footer-col">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li>
                <a href="tel:+16476162595">+1 (647) 616-2595</a>
              </li>
              <li>
                <a href="mailto:sales@candron.com">sales@candron.com</a>
              </li>
              <li>
