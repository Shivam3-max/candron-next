    ...
    <>
        ...
        <div className="container">
          <div className="split" style={{ alignItems: 'start', gap: '3.5rem' }}>
            <div className="rv-l">
              ...
              <h2 style={{ marginBottom: '1.25rem' }}>Built to Your Spec,<br />Tested Before It Ships</h2>
              <p className="body" style={{ marginBottom: '1.5rem' }}>Every control panel is engineered to your process requirements and assembled in-house. Our team handles mechanical design, electrical schematics, PLC programming, HMI configuration, and full factory acceptance testing — so you receive a panel that is ready to connect.</p>
            ...
            <div className="rv-r" style={{ position: 'relative' }}>
              <div className="prod-detail-img">
                <Image src="/images/control-panels.jpg" alt="Candron control panel assembly" fill style={{ objectFit: 'cover' }} sizes="(max-width:1024px) 100vw,50vw" />
              ...
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', background: 'transparent', borderTop: '1px solid rgba(255,255,255,.12)', borderRadius: '0 0 14px 14px' }}>
                <div style={{ padding: '.95rem .5rem', textAlign: 'center', borderRight: '1px solid rgba(255,255,255,.08)' }}>
                  <div style={{ fontFamily: 'var(--fd)', fontSize: '.85rem', fontWeight: 900, color: '#fff', letterSpacing: '.04em', marginBottom: '.2rem' }}>UL 508A</div>
                  <div style={{ fontFamily: 'var(--fm)', fontSize: '.5rem', color: 'rgba(255,255,255,.45)', letterSpacing: '.16em', textTransform: 'uppercase' }}>Listed</div>
                </div>
                <div style={{ padding: '.95rem .5rem', textAlign: 'center', borderRight: '1px solid rgba(255,255,255,.08)' }}>
                  <div style={{ fontFamily: 'var(--fd)', fontSize: '.85rem', fontWeight: 900, color: '#fff', letterSpacing: '.04em', marginBottom: '.2rem' }}>Custom</div>
                  <div style={{ fontFamily: 'var(--fm)', fontSize: '.5rem', color: 'rgba(255,255,255,.45)', letterSpacing: '.16em', textTransform: 'uppercase' }}>Built</div>
                </div>
                <div style={{ padding: '.95rem .5rem', textAlign: 'center', borderRight: '1px solid rgba(255,255,255,.08)' }}>
                  <div style={{ fontFamily: 'var(--fd)', fontSize: '.85rem', fontWeight: 900, color: '#fff', letterSpacing: '.04em', marginBottom: '.2rem' }}>PLC / HMI</div>
                  <div style={{ fontFamily: 'var(--fm)', fontSize: '.5rem', color: 'rgba(255,255,255,.45)', letterSpacing: '.16em', textTransform: 'uppercase' }}>Integration</div>
                </div>
                <div style={{ padding: '.95rem .5rem', textAlign: 'center' }}>
                  <div style={{ fontFamily: 'var(--fd)', fontSize: '.85rem', fontWeight: 900, color: '#fff', letterSpacing: '.04em', marginBottom: '.2rem' }}>SCADA</div>
                  <div style={{ fontFamily: 'var(--fm)', fontSize: '.5rem', color: 'rgba(255,255,255,.45)', letterSpacing: '.16em', textTransform: 'uppercase' }}>Ready</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="types-specs" className="section bg-off" style={{ scrollMarginTop: '110px' }}>
        <div className="container">
          ...
          <h2 className="rv" style={{ marginBottom: '.75rem' }}>Control Panel Configurations</h2>
              ...
              <div key={i} className="rv" style={{ background: '#fff', borderRadius: '14px', border: '1px solid #E8ECF5', overflow: 'hidden', boxShadow: openAcc === i ? '0 8px 32px rgba(5,9,31,.1)' : 'none', transition: 'box-shadow .2s' }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: '.4rem', flexShrink: 0, marginRight: '.25rem' }}>
                    ...
                    <span style={{ background: 'rgba(0,71,255,.07)', color: 'var(--blue)', fontFamily: 'var(--fm)', fontSize: '.55rem', fontWeight: 700, letterSpacing: '.04em', padding: '.22rem .6rem', borderRadius: '5px', whiteSpace: 'nowrap' }}>{t.specs.Protocol}</span>
                  </div>
      ...
      <div id="applications" className="section bg-off" style={{ scrollMarginTop: '110px' }}>
        <div className="container">
          ...
          <h2 className="rv" style={{ marginBottom: '2.5rem' }}>Where Our Panels Are Deployed</h2>
          <div className="split" style={{ alignItems: 'start', gap: '3.5rem' }}>
            <div className="rv-l">
            ...
            <div className="rv-r" style={{ background: 'var(--navy)', borderRadius: '16px', padding: '2rem 2.25rem', border: '1px solid rgba(0,71,255,.2)' }}>
              ...
              <h3 style={{ color: '#fff', marginBottom: '1rem', fontSize: '1.05rem' }}>Engineering to commissioning — one team.</h3>
        ...
        <div className="container">
          <div className="split" style={{ alignItems: 'center', gap: '3.5rem' }}>
            <div className="rv-l">
              ...
              <h2 style={{ marginBottom: '1.5rem' }}>Request Control Panel Pricing</h2>
