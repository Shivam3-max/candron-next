          ...
          >
            ...
            <div className="rv-r">
              <div className="sticky-cta">
                ...
                <p>
                  Candron accommodates witnessed factory acceptance tests for
                  project owners, engineers of record, and third-party
                  inspectors. Schedule your FAT visit during the project kickoff
                  to ensure alignment with your project timeline.
                </p>
                <Link
                  href="/contact"
        ...
        <div className="container">
          ...
          <div className="standard-grid">
            ...
            <div className="standard-card rv d2">
              ...
              <div className="standard-desc">
                Institute of Electrical and Electronics Engineers testing
                standards
              </div>
            </div>
            ...
            <div className="standard-card rv d4">
              ...
              <div className="standard-desc">
                Canadian Standards Association — full compliance for Canadian
                projects
              </div>
            </div>
            <div className="standard-card rv d5">
              ...
              <div className="standard-desc">
                Underwriters Laboratories listing and certification requirements
              </div>
            </div>
          </div>
        </div>
